  ...
  return(
      ...
      <div className="sidebar-main-header">
        ...
        <div style={{ display: facultyVisi }}>
          ...
          <div className="Items" style={{ display: admin }} onClick={props.onCreateFaculty}>&#x3e;&nbsp;&nbsp;Create Subject</div>
          <div className="Items" style={{ display: admin }} onClick={props.onVendorCreate}>&#x3e;&nbsp;&nbsp;Create Exam</div>
          <div className="Items" style={{ display: admin }} onClick={props.onCreateFaculty}>&#x3e;&nbsp;&nbsp;Create Internal Marks Entry</div>
          <div className="Items" style={{ display: admin }} onClick={props.onVendorCreate}>&#x3e;&nbsp;&nbsp;Create External Marks Entry</div>
          <div className="Items" style={{ display: admin }} onClick={props.onVendorCreate}>&#x3e;&nbsp;&nbsp;Export Student Marks</div>
        </div>
        ...
        <div className="Items" style={{ display: studentAdmin }} onClick={props.onMasterStudentEntry}>&#x3e;&nbsp;&nbsp;Master Admission Entry</div>
          <div className="Items" style={{ display: studentAdmin }} onClick={props.onMasterStudentView}>&#x3e;&nbsp;&nbsp;View/Edit Master Entry</div>
          <div className="Items" style={{ display: studentAdmin }} onClick={props.onAcademicEntryUpdate}>&#x3e;&nbsp;&nbsp;Academic Entry</div>
          <div className="Items" style={{ display: studentAdmin }} onClick={props.onAcademicView}>&#x3e;&nbsp;&nbsp;Export Academic Entry</div>
          <div className="Items" style={{ display: studentAdmin }} onClick={props.onVendorCreate}>&#x3e;&nbsp;&nbsp;Promote To Next Class</div>
        </div>
